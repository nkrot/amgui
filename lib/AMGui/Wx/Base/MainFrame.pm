# generated by wxGlade 0.7.1 on Sat Jan 23 14:37:51 2016
#
...
sub onListClick {
    my ($self, $event) = @_;
    # wxGlade: AMGui::Wx::Base::MainFrame::onListClick <event_handler>
    warn "Event handler (onListClick) not implemented";
    $event->Skip;
    # end wxGlade
}
