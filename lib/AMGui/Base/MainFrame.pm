# generated by wxGlade 0.7.1 on Thu Jan 21 17:43:02 2016
#
...
sub new {
    ...
    $self->{lbFileData} = Wx::ListBox->new($self->{notebook}, wxID_ANY, wxDefaultPosition, wxDefaultSize, [_T("Load data from a file")], wxLB_SINGLE);
...
sub __do_layout {
    ...
    $self->{notebook}->AddPage($self->{lbFileData}, _T("NoFile"));
    $self->{window_1}->SplitVertically($self->{leftWindow}, $self->{notebook}, );
